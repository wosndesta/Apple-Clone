...
function Footer() {
	if ($(window).width() <= 768) {
		$(".ten-links ").addClass("someClass");
	} else {
		$(".ten-links ").removeClass("someClass");
		$(".ten-links ul").show();
	}
			...
			<footer className="footer-holder">
				<div className="internal-holder">
					<div className="trade-in">
						<div className="first-text-container container">
					...
					<div className="ten-links  container ">
						<div className="row">
							<div className="links-1 col-md">
					...
					<div className="footer-last container">
						...
						<div className="copyright-box">
							<div className="row">
								<div className="copyright col-md-4 order-3 order-md-1">
									Copyright © 2019 Apple Inc. All rights reserved.
								</div>
								<div className="footer-terms col-md-6 order-2 order-md-2">
									<ul>
										<li>
								...
								<div className="footer-united col-md-2 order-1 order-md-3 ">
